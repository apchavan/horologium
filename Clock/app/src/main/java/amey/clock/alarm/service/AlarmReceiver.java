...
import amey.clock.alarm.ui.AlarmLandingPageActivity;
...
public final class AlarmReceiver extends BroadcastReceiver {
    ...
    public static void cancelReminderAlarm(Context context, Alarm alarm) {
        ...
        Objects.requireNonNull(manager).cancel(pIntent);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        final Intent notifyIntent = new Intent(context, AlarmLandingPageActivity.class);
        ...
        builder.setContentTitle(context.getString(R.string.alarm_str));

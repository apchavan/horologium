...
import static amey.clock.alarm.data.DatabaseHelper.COL_FRI;
import static amey.clock.alarm.data.DatabaseHelper.COL_IS_ENABLED;
import static amey.clock.alarm.data.DatabaseHelper.COL_LABEL;
import static amey.clock.alarm.data.DatabaseHelper.COL_MON;
import static amey.clock.alarm.data.DatabaseHelper.COL_SAT;
import static amey.clock.alarm.data.DatabaseHelper.COL_SUN;
import static amey.clock.alarm.data.DatabaseHelper.COL_THURS;
import static amey.clock.alarm.data.DatabaseHelper.COL_TIME;
import static amey.clock.alarm.data.DatabaseHelper.COL_TUES;
import static amey.clock.alarm.data.DatabaseHelper.COL_WED;
import static amey.clock.alarm.data.DatabaseHelper._ID;
...
public final class AlarmUtils {
    ...
    /*
    * The method below is commented since not currently used.
    * To get active alarm days as String just un-comment & call method below properly as required.
    */
